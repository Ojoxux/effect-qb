...
const main = async () => {
  ...
  try {
    ...
    await Bun.write(join(consumerDir, "index.ts"), [
      'import { Column, Function, Query as StandardQuery, Table } from "effect-qb"',
      'import { Query } from "effect-qb/postgres"',
      'import { Json as MysqlJson, Scalar as MysqlScalar } from "effect-qb/mysql"',
